...
export default function Hero() {
  ...
  return (
    <section id="hero" className="hero relative flex w-full h-screen select-none items-center justify-center" aria-label="hero">
      <div className="z-10 flex flex-col  w-full items-center text-title 2xl:text-[8vw] 2xl:space-y-8 font-bold  uppercase text-accent-300">
        <div className="title 2xl:py-8">
          {/* Learn more about useRef */}
          <h1 ref={(el) => (titles.current[0] = el)} className="translate-y-96 overflow-visible" style={{ fontSize: '9vw' }}>
            Hey, I&apos;m Gursewak
          </h1>
        </div>
        <div className=" title 2xl:py-8">
        <h1 ref={(el) => (titles.current[1] = el)} className="translate-y-96 font-outline-3 md:font-outline-4 text-transparent overflow-visible" style={{ fontSize: '9vw' }}>            Hey, I&apos;m Gursewak
          </h1>
        </div>
        <div className=" title 2xl:py-8">
          <h1 ref={(el) => (titles.current[2] = el)} className="translate-y-96" style={{ fontSize: '9vw' }}>
            Hey, I&apos;m Gursewak
          </h1>
        </div>
      </div>
